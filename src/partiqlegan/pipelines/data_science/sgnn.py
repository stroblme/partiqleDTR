...
class sgnn(nn.Module):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if self.factor:
            ...
            self.blocks = nn.ModuleList([
                ...
                nn.ModuleList([
                    ...
                    nn.ModuleList([
                        MLP(2*dim_feedforward, dim_feedforward, dim_feedforward, dropout_rate, batchnorm),
        ...
        final_mlp = [MLP(2*dim_feedforward, dim_feedforward, dim_feedforward, dropout_rate, batchnorm)]
        # Add any additional layers as per request
        final_mlp.extend([
