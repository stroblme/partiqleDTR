...
def train(parameters):
    ...
    BATCH_SIZE = parameters["BATCH_SIZE"] if "BATCH_SIZE" in parameters else None
    OPTIMIZER = parameters["OPTIMIZER"] if "OPTIMIZER" in parameters else None
    LOSS_FUNC = parameters["LOSS_FUNC"] if "LOSS_FUNC" in parameters else None
    N_EPOCH = parameters["N_EPOCH"] if "N_EPOCH" in parameters else None
    LR_C = parameters["LR_C"] if "LR_C" in parameters else None
    N_TRAIN = parameters["N_TRAIN"] if "N_TRAIN" in parameters else None
