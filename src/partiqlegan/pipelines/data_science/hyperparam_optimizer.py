...
class Hyperparam_Optimizer:
    def __init__(self, name:str, id:int, host: str, port: int, path: str, password: str):
        ...
        self.study = o.create_study(pruner=pruner, sampler=sampler, direction="minimize",
                                    load_if_exists=True, study_name=name,
                                    storage=storage)
    ...
    def update_variable_parameters(self, trial, parameters):
        ...
        for parameter, value in parameters.items():
            ...
            if len(value) == 3 and type(value[0])!=str and type(value[1])!=str:
                ...
                updated_variable_parameters[parameter] = trial.suggest_categorical(parameter, *value)
